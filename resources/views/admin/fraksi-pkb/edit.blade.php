...
<div class="container py-5">
    <div class="card bg-secondary">
        <div class="card-header">
            <h5 class="card-title">Edit Data Anggota Fraksi PKb</h5>
        </div>

        <div class="card-body">
            <form action="{{ route('pkb.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT') 
                ...
                <div class="mb-3">
                    ...
                    @if ($data->logo)
                        <div class="mb-2">
                            <img src="{{ asset('uploads/fraksi-pkb/' . $data->logo) }}" alt="Logo Saat Ini" style="width: 100px; height: 100px; object-fit: cover;">
                ...
                <div class="text-end mt-4">
                    <a href="{{ route('pkb.index') }}" class="btn btn-danger">Kembali</a>
