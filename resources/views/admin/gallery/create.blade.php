                ...
                <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="path_gambar"
                            class="form-control @error('path_gambar') is-invalid @enderror" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="body" class="form-control @error('body') is-invalid @enderror" rows="10" required
                            placeholder="Tuliskan berita lengkap di sini...">{{ old('body') }}</textarea>
