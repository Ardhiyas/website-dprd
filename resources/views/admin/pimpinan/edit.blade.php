...
<div class="container py-5">
    <div class="card bg-secondary">
        <div class="card-header">
            <h5 class="card-title">Edit Pimpinan</h5>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('pimpinan.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    @if($data->foto)
                        <img src="{{ asset('uploads/pimpinan/'.$data->foto) }}" width="100" class="mb-2 rounded">
                    @else
                ...
                <div class="text-end">
                    <a href="{{ route('pimpinan.index') }}" class="btn btn-danger">Kembali</a>
