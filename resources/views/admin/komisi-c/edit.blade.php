    ...
    <div class="container py-5">
        <div class="card bg-secondary">
            <div class="card-header">
                <h5 class="card-title">Edit Anggota Komisi C</h5>
            </div>

            <div class="card-body">
                <form action="{{ route('komisi-c.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        @if($data->foto)
                            <img src="{{ asset('uploads/komisi-c/' . $data->foto) }}" width="100" class="mb-2 rounded">
                        @else
