            ...
            <div class="row gy-4">
                ...
                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-start mb-4 mb-lg-0" data-aos="fade-up"
                    ...
                    <div class="features-image-wrapper text-center" id="foto-fraksi">
                        @if ($config)
                            <img src="{{ asset('uploads/fraksi-golkar/' . $config->logo) }}" alt="{{ $config->judul }}"
                                class="img-fluid rounded shadow-sm" style="max-height: 300px; width: auto;">
                        @else
                            <img src="URL_LOGO_DEFAULT_JIKA_KOSONG" alt="Logo Default" class="img-fluid rounded shadow-sm">
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    @else
                        <h3 class="text-center text-lg-start mb-3">Struktur Anggota Fraksi Golkar (Data Belum Tersedia)</h3>
                        <p class="fst-italic text-center text-lg-start mb-4" id="deskripsi">Silakan masukkan data fraksi melalui
                            halaman admin.</p>
                    @endif
                            ...
                            <tbody class="align-middle">
                                @forelse ($fraksiData as $key => $anggota)
                                    <tr>
                                        ...
                                        <td>{{ $anggota->nama }}</td>
                                        <td>
                                            <span class="badge bg-warning px-3 py-2 text-dark d-inline-block text-truncate"
