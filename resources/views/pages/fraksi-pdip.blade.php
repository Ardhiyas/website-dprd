            ...
            <div class="row gy-4">
                ...
                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-start mb-4 mb-lg-0" data-aos="fade-up"
                    ...
                    <div class="features-image-wrapper text-center" id="foto-fraksi">
                        @if ($config)
                            <img src="{{ asset('uploads/fraksi-pdip/' . $config->logo) }}" alt="{{ $config->judul }}"
                ...
                <div class="col-12 col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    @else
                        <h3 class="text-center text-lg-start mb-3">Struktur Anggota Fraksi PDIP (Data Belum Tersedia)</h3>
