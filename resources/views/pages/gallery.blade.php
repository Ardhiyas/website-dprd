            ...
            <div class="col">
                <div class="card h-100 shadow-lg border-0 rounded-4 card-hover">
                    <div class="img-container rounded-top-4">
                        ...
                        <img src="{{ asset('uploads/gallery/' . $item->path_gambar) }}"
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="{{ route('gallery.show', $item->slug ?? $item->id) }}" class="btn btn-primary btn-rounded px-4 mt-auto">Selengkapnya</a>
                    </div>
                </div>
            </div>
        @empty
