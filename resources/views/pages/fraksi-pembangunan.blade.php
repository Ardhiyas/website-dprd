        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-12 col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    @else
                        <h3 class="text-center text-lg-start mb-3">Struktur Anggota Fraksi Pembangunan (Data Belum Tersedia)
                        </h3>
                            ...
                            <tbody class="align-middle">
                                @forelse ($fraksiData as $key => $anggota)
                                    <tr>
                                        ...
                                        <td>{{ $anggota->nama }}</td>
                                        <td>
                                            <span class="badge bg-warning px-3 py-2 text-white d-inline-block text-truncate"
